...
import birthreportStyles from './birth-star-report.module.scss';

const businessereport = () => {
  return (
    <div>
      <HeaderComponent />
      <div className={birthreportStyles.astPagetitle}>
        <div className={birthreportStyles.astImgOverlay}></div>
        <div className="container">
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12">
              <div className={birthreportStyles.pageTitle}>
                <h1>Birth Star Report</h1>
              </div>
            </div>
            <div className="col-lg-12 col-md-12 col-sm-12">
      ...
      <div className={birthreportStyles.astVastuWrapper}>
        <div className="container">
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div className={birthreportStyles.astVastuInfo}>
                ...
                <div className={birthreportStyles.cta}>
                  <h4>Get Sample Birth Star Report
                  </h4>
                  <a
                  ...
                  >
                    <button className={birthreportStyles.downloadBtn}>
                      <FontAwesomeIcon icon={['fas', 'phone-volume']} />{' '}
                      Download Now
                    </button>
                  </a>
                </div>
                <h2 className={birthreportStyles.reportTitle}>
                Get Birth Star Report
                </h2>
                <div className="ast_journal_box_wrapper">
                  ...
                  >
                    ...
                    <form
                      ...
                      method="post"
                      className={birthreportStyles.formWrapper}
                    ...
                    >
                      ...
                      <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 payment-div">
                          ...
                          <br />
                          <span className={birthreportStyles.wrapPayment}>
                            <span className="wpcf7-form-control wpcf7-radio">
                              <span className={birthreportStyles.formList}>
                                <input
                                  type="radio"
                                  name="payment"
                          ...
                          <br />
                          <span className={birthreportStyles.bankDetails}>
                            <br />
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <img
                            ...
                            className={birthreportStyles.paymentImg}
                            alt="payment"
                            title="payment"
                          />
                        </div>
                      ...
                      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <input
                          type="submit"
                          value="Send"
                          className={`${birthreportStyles.submitBtn} wpcf7-form-control wpcf7-submit asn_btn pull-right w-100`}
                        />
                      </div>
                      <div
